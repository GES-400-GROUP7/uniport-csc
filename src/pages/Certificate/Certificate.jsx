    ...
    <Layout>
      <main className="w-full">
        ...
        <section className="px-16 py-10 md:px-32 md:py-20">
          <p className="text-[#E3002F] pb-8 text-sm font-semibold">
            Make sure to input your correct information (apply once and wait for
          ...
          >
            ...
            />
            <div>
              <p className="text-[#002660] text-sm font-medium my-2">
                Fields with <span className="text-[#E3002F] font-bold">*</span>{" "}
                are compulsory, they must not be skipped{" "}
              </p>
              <ToastContainer />
              <button
